...
You can also use global signals in your project by adding [this repository](https://github.com/mofrison/global-signals) as a [submodule](https://git-scm.com/book/en/v2/Git-Tools-Submodules):
